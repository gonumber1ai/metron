...
import { Countdown, useOfferExpired } from "@/components/c/Countdown";
...
const EN: Copy = {
  ...
  l: { tagline: "LONGER LASTING SEX", cta: "START DAY 1 FREE", timer: "SPECIAL OFFER ENDS IN", expired: "OFFER EXPIRED", expiredNotice: "Your {offer} offer has expired. You are now at the price everyone pays: {full}.", heroA: "10 DAYS FOR YOU", heroB: "TO LAST LONGER", heroC: "AND CONSISTENTLY", heroSub: "", askKicker: "ONLY ONE QUESTION:", ctaShort: "START FREE", login: "Log in", homeHeroSub: "No pills, no herbs. 15 minutes a day of exercises to last longer in bed — timed on Day 1 and again on Day 12.", homeTrainingSub: "Exercises to last longer in bed, 15 minutes a day, in an order that builds. Day 1: time how long you last. Days 2–10: train. Day 12: time it again.", homeNext: "After Day 12 there is a 30-Day Program. It takes what the ten days built, loads it heavier, and moves it into real sex, with her. It opens after Day 12, not before — how long you last on Day 12 decides whether you want it.", partnerNote: "Sending this to him? Day 1 is free and takes 5 minutes.", dareA: "Tonight, time yourself.", dareB: "Find out exactly how long you last. Most men have never checked — they guess.", dareC: "Then decide if you want to change it.", dareCta: "Start Day 1 free", ctaSub: "Days 2–10: 4 900 FCFA", railJourney: "MEASURED, TRAINED, MEASURED AGAIN", railMindset: "WHAT ELSE CHANGED", railPartner: "WHAT THEIR PARTNERS SAY", railProof: "MORE FROM MEN WHO DID IT", railProgression: "WHY THEY CARRIED ON", moreLabel: "MORE METRON EXPERIENCES", plan10: "10-Day Challenge", plan30: "30-Day Program", railPrev: "Previous", railNext: "Next", playLabel: "Watch (10 sec)", closeLabel: "Close", videoHead: "TWO CLIENTS. TEN SECONDS EACH.", question: "QUESTION {n} OF {total}", next: "NEXT QUESTION", goodKicker: "BASED ON YOUR ANSWERS", goodA: "YOU'RE A", goodB: "GOOD FIT", goodSub: "You don't need pills or complicated routines.", gymA: "METRON IS LIKE A GYM", gymB: "FOR YOUR SEXUAL PERFORMANCE.", gymBody: "But no heavy lifting. No two-hour sessions. No forever. Just a simple plan you can follow in about 15 minutes a day.", trainingKicker: "HOW METRON WORKS", trainingA: "REAL TRAINING", trainingB: "FOR REAL RESULTS.", trainingSub: "You don't build physical control by wishing for it. You train it.", planKicker: "THE 10-DAY CHALLENGE", planA: "A SIMPLE PLAN.", planB: "REAL RESULTS.", planSub: "Start with 10 days. Measure the difference yourself.", diffKicker: "THE DIFFERENCE", diffA: "SAME YOU.", diffB: "A BETTER EXPERIENCE.", proofKicker: "PROOF", proofA: "SIMPLE. MEASURED.", proofB: "REAL RESULTS.", costKicker: "THE COST OF", costA: "NOT STARTING", costB: "IS HIGHER THAN YOU THINK.", getA: "10 DAYS TO A", getB: "LONGER LASTING YOU", getC: "AND A HAPPIER SEX LIFE.", closeA: "READY FOR", closeB: "YOUR RESULTS?", closeSub: "Your 10-day challenge is reserved at {price} for the next 7 hours.", closeSubFlat: "Day 1 is free. Days 2–10: {price}. Pay only after you've timed how long you last.", closeSubExpired: "Your reserved price has expired. The 10-day challenge is {price} — the price everyone pays.", nextKicker: "AFTER YOUR 10 DAYS", nextA: "THE MAIN PROGRAM IS", nextB: "THE 30-DAY PROGRAM.", nextPriceNote: "30-DAY PROGRAM", nextSub: "This is the one that changes it for good. It holds the time you gained and moves it out of your own hands and into real sex.", next1: "Everything in the 10-day challenge, continued and loaded heavier", next2: "The partner phase — control on your own and control with her are two different skills", next3: "What to say to her, so it never feels like a clinic", next4: "Food, sleep and strength work that support the rest", nextNote: "But we are not asking you for that today. Start with the 10-day challenge at {price}, measure on day 10, and let how long you last tell you whether this works. Almost every man who sees it move goes on to the 30 days." , script: "A Better You in Bed", bonusDay: "DAY 10", bonusWord: "BONUS", bonusH: "How to make her come first", bonusBody: "Know her arousal point for a more satisfying experience for both of you.", diffSub: "It’s not about being someone else. It’s about getting better at what matters.", withoutH: "WITHOUT METRON", withH: "WITH METRON", proofSub: "Simple. No pills. No herbs. 15 minutes a day. Measured.", reviewA: "REAL MEN.", reviewB: "REAL RESULTS.", costSub: "The longer you stay at a particular duration, the harder it becomes to change it.", costBody1: "If you’re unhappy with your sexual performance, waiting another month doesn’t make you last longer.", costBold: "Training does.", costBody2: "{price} shouldn’t be the reason you spend another month unhappy with your sex life.", closeNote: "You can either keep wondering if you can improve — or spend the next 10 days finding out." },

  units: ["HRS", "MINS", "SECS"],
  benefits: [["chart", "Measurable.", "Day 1: time how long you last. Day 12: again."], ["leaf", "No pills.", "No herbs."], ["clock", "Just 15 minutes", "a day."], ["chart", "Real results.", "Naturally."]],
  trust: [["chart", "Measurable", "Day 1: time how long you last. Day 12: again."], ["leaf", "No pills. No herbs.", "Just training."], ["phone", "Works on any device", "Train from your phone."]],
  ...
  timeline: [["DAY 1", "Time how long you last."], ["DAYS 2–9", "Follow your daily training."], ["DAY 10", "Repeat the measurement. See what changed."]],
...
const FR: Copy = { quiz: [{ q: "Pouvez-vous consacrer 15 minutes par jour pendant les 10 prochains jours pour y arriver ?", options: ["Oui, je peux"] }], l: { ...EN.l, tagline: "DU SEXE QUI DURE PLUS LONGTEMPS", cta: "COMMENCER LE JOUR 1 GRATUIT", timer: "OFFRE SPÉCIALE SE TERMINE DANS", expired: "OFFRE EXPIRÉE", expiredNotice: "Votre offre à {offer} a expiré. Vous êtes maintenant au prix que tout le monde paie : {full}.", heroA: "10 JOURS POUR", heroB: "TENIR PLUS LONGTEMPS", heroC: "ET DE FAÇON CONSTANTE", heroSub: "", askKicker: "UNE SEULE QUESTION :", ctaShort: "GRATUIT", login: "Se connecter", homeHeroSub: "Pas de pilules, pas de plantes. 15 minutes par jour d'exercices pour durer plus longtemps au lit — chronométrés au jour 1 et à nouveau au jour 12.", homeTrainingSub: "Des exercices pour durer plus longtemps au lit, 15 minutes par jour, dans un ordre qui construit. Jour 1 : chronométrez combien de temps vous tenez. Jours 2 à 10 : entraînez-vous. Jour 12 : chronométrez à nouveau.", homeNext: "Après le jour 12, il y a un programme de 30 jours. Il reprend ce que les dix jours ont construit, charge plus lourd, et l'amène dans de vrais rapports, avec elle. Il s'ouvre après le jour 12, pas avant — le temps que vous tenez au jour 12 décide si vous le voulez.", partnerNote: "Vous l'envoyez à votre homme ? Le jour 1 est gratuit et prend 5 minutes.", dareA: "Ce soir, chronométrez-vous.", dareB: "Sachez exactement combien de temps vous tenez. La plupart des hommes ne l'ont jamais vérifié — ils devinent.", dareC: "Ensuite, décidez si vous voulez changer ça.", dareCta: "Commencer le jour 1 gratuit", ctaSub: "Jours 2–10 : 4 900 FCFA", railJourney: "MESURÉ, ENTRAÎNÉ, REMESURÉ", railMindset: "CE QUI A CHANGÉ D’AUTRE", railPartner: "CE QU’EN DISENT LEURS PARTENAIRES", railProof: "D’AUTRES HOMMES QUI L’ONT FAIT", railProgression: "POURQUOI ILS ONT CONTINUÉ", moreLabel: "PLUS D’EXPÉRIENCES METRON", plan10: "Défi 10 jours", plan30: "Programme 30 jours", railPrev: "Précédent", railNext: "Suivant", playLabel: "Regarder (10 s)", closeLabel: "Fermer", videoHead: "DEUX CLIENTS. DIX SECONDES CHACUN.", question: "QUESTION {n} SUR {total}", next: "QUESTION SUIVANTE", goodKicker: "D'APRÈS VOS RÉPONSES", goodA: "VOUS ÊTES", goodB: "UN BON PROFIL", goodSub: "Vous n'avez besoin ni de pilules ni de routines compliquées.", gymA: "METRON, C'EST COMME UNE SALLE", gymB: "POUR VOTRE PERFORMANCE SEXUELLE.", gymBody: "Pas de charges lourdes. Pas de séances de deux heures. Juste un plan simple, environ 15 minutes par jour.", trainingKicker: "COMMENT METRON FONCTIONNE", trainingA: "UN VRAI ENTRAÎNEMENT", trainingB: "POUR DE VRAIS RÉSULTATS.", trainingSub: "On ne construit pas le contrôle physique en le souhaitant. On l'entraîne.", planKicker: "LE DÉFI DE 10 JOURS", planA: "UN PLAN SIMPLE.", planB: "DE VRAIS RÉSULTATS.", planSub: "Commencez par 10 jours. Mesurez vous-même la différence.", diffKicker: "LA DIFFÉRENCE", diffA: "LE MÊME VOUS.", diffB: "UNE MEILLEURE EXPÉRIENCE.", proofKicker: "LA PREUVE", proofA: "SIMPLE. MESURÉ.", proofB: "DE VRAIS RÉSULTATS.", costKicker: "LE COÛT DE", costA: "NE PAS COMMENCER", costB: "EST PLUS ÉLEVÉ QUE VOUS NE PENSEZ.", getA: "10 JOURS POUR", getB: "TENIR PLUS LONGTEMPS", getC: "ET UNE VIE SEXUELLE PLUS HEUREUSE.", closeA: "PRÊT POUR", closeB: "VOS RÉSULTATS ?", closeSub: "Votre défi de 10 jours est réservé à {price} pour les 7 prochaines heures.", closeSubFlat: "Le jour 1 est gratuit. Jours 2–10 : {price}. Vous payez seulement après avoir chronométré combien de temps vous tenez.", closeSubExpired: "Votre prix réservé a expiré. Le défi de 10 jours est à {price} — le prix que tout le monde paie.", nextKicker: "APRÈS VOS 10 JOURS", nextA: "LE PROGRAMME PRINCIPAL,", nextB: "C’EST CELUI DE 30 JOURS.", nextPriceNote: "PROGRAMME DE 30 JOURS", nextSub: "C’est celui qui change les choses pour de bon. Il consolide le temps gagné et le fait sortir de vos propres mains pour aller dans de vrais rapports.", next1: "Tout ce qu'il y a dans le défi de 10 jours, poursuivi et intensifié", next2: "La phase avec partenaire — se contrôler seul et se contrôler avec elle sont deux compétences différentes", next3: "Quoi lui dire, pour que ça ne ressemble jamais à une consultation", next4: "Alimentation, sommeil et travail de force pour soutenir le reste", nextNote: "Mais on ne vous demande pas ça aujourd'hui. Commencez par le défi de 10 jours à {price}, mesurez au jour 10, et laissez le temps que vous tenez vous dire si ça marche. Presque tous les hommes qui le voient bouger enchaînent avec les 30 jours." , script: "Un Meilleur Vous au Lit", bonusDay: "JOUR 10", bonusWord: "BONUS", bonusH: "Comment la faire jouir en premier", bonusBody: "Connaissez son point d’excitation pour une expérience plus satisfaisante pour vous deux.", diffSub: "Il ne s’agit pas de devenir quelqu’un d’autre. Il s’agit de progresser là où ça compte.", withoutH: "SANS METRON", withH: "AVEC METRON", proofSub: "Simple. Pas de pilules. Pas de plantes. 15 minutes par jour. Mesuré.", reviewA: "DE VRAIS HOMMES.", reviewB: "DE VRAIS RÉSULTATS.", costSub: "Plus vous restez à une certaine durée, plus il devient difficile de la changer.", costBody1: "Si vous n’êtes pas satisfait de votre performance sexuelle, attendre un mois de plus ne vous fera pas tenir plus longtemps.", costBold: "L’entraînement, oui.", costBody2: "{price} ne devrait pas être la raison pour laquelle vous passez encore un mois insatisfait de votre vie sexuelle.", closeNote: "Vous pouvez continuer à vous demander si vous pouvez progresser — ou passer les 10 prochains jours à le découvrir." } ,
  units: ["H", "MIN", "SEC"],
  benefits: [["chart", "Mesurable.", "Jour 1 : chronométrez combien de temps vous tenez. Jour 12 : encore."], ["leaf", "Pas de pilules.", "Pas de plantes."], ["clock", "Juste 15 minutes", "par jour."], ["chart", "De vrais résultats.", "Naturellement."]],
  trust: [["chart", "Mesurable", "Jour 1 : chronométrez combien de temps vous tenez. Jour 12 : encore."], ["leaf", "Pas de pilules. Pas de plantes.", "Juste de l’entraînement."], ["phone", "Sur n’importe quel appareil", "Entraînez-vous depuis votre téléphone."]],
  ...
  timeline: [["JOUR 1", "Chronométrez combien de temps vous tenez."], ["JOURS 2–9", "Suivez votre entraînement quotidien."], ["JOUR 10", "Refaites la mesure. Voyez ce qui a changé."]],
...
/**
 * One page, two variants — never two pages.
 *
 *   funnel   the ad page (/c). The one question gates the rest; the "good
 *            fit" block answers it; noindex; campaign from the URL.
 *   home     metron.life. A man arriving direct was not just told what his
 *            problem is, so the page says it first and lets him self-select:
 *            no question, no "based on your answers", the button in the
 *            hero, campaign "direct", indexable, and the proof only where it
 *            is consented (NEXT_PUBLIC_HOME_PROOF=1) — the homepage is the
 *            one page a search engine can find a man through.
 */
export type Variant = "funnel" | "home";
const HOME_PROOF = process.env.NEXT_PUBLIC_HOME_PROOF === "1";

export function ChallengeClient({ locale, geoCountry, variant = "funnel" }: { locale: string; geoCountry?: string | null; variant?: Variant }) {
  const { quiz, l, units, benefits, trust, pillars, timeline, without, with: withList, proofPoints, includes } = locale === "fr" ? FR : EN; const home = variant === "home"; const proof = !home || HOME_PROOF; const tag = home ? "home" : "c"; const [passed, setPassed] = useState(home); const reveal = useRef<HTMLDivElement>(null);
  ...
  useEffect(() => { if (home) return; try { if (window.localStorage.getItem(PASSED_KEY) === "1") { setPassed(true); setRestored(true); } } catch {} }, [home]);
  ...
  const rows = getPrices(geoCountry ?? "default");
  ...
  const price = (expired ? testRow?.was : testRow?.display) ?? testRow?.display ?? "2 500 FCFA"; const direct = getDirect(locale); const marketing = getMarketing(locale);
  useEffect(() => { try { const p = new URLSearchParams(window.location.search); const campaign = home ? "direct" : (p.get("c") ?? p.get("utm_campaign") ?? "").replace(/[^a-zA-Z0-9_-]/g, "").slice(0, 40); if (campaign) update((s) => s.campaign ? s : { ...s, campaign }, locale); } catch {} track("start_view", tag, locale); }, [locale, home, tag]);
  const complete = useCallback(() => { setPassed(true); try { window.localStorage.setItem(PASSED_KEY, "1"); } catch {} track("quiz_complete", "c", locale); window.setTimeout(() => reveal.current?.scrollIntoView({ behavior: "smooth", block: "start" }), 80); }, [locale]);
  ...
  const Go = ({ where, className = "", compact = false }: { where: string; className?: string; compact?: boolean }) => <Link href={`/${locale}/signup`} onClick={() => track("start_cta", `${tag}_${where}`, locale)} className={`btn-lime c-cta ${className}`}><span className="c-cta-label">{compact ? l.ctaShort : l.cta}</span><span className="c-cta-price">{l.ctaSub}</span></Link>;
  ...
  return <><style>{`body{background:#030303;color:#fff}body::before{display:none}`}</style><MetaPixel event="ViewContent" /><div className="c-page"><header className="c-bar"><div className="c-bar-inner"><span className="c-brand"><Logo size="sm" /><small>{l.tagline}</small></span><Link href={`/${locale}/login`} className="c-bar-login">{l.login}</Link></div></header><main className="c-shell">
    <section className="c-hero c-photo"><Image src="/c/hero.jpg" fill priority sizes="(max-width: 768px) 100vw, 1100px" alt="" className="c-photo-image" /><div className="c-photo-shade" /><div className="c-hero-copy"><h1 className="c-heading">{l.heroA}<br /><span>{l.heroB}</span><br />{l.heroC}</h1><i className="c-rule" />{(home ? l.homeHeroSub : l.heroSub) && <p className="c-lede">{home ? l.homeHeroSub : l.heroSub}</p>}<div className="c-benefits">{benefits.map(([icon, title, sub]) => <div key={title}><b><Icon name={icon as IconName} /></b><strong>{title}</strong><small>{sub}</small></div>)}</div><p className="c-script">{l.script}</p></div></section>
    <section className="c-dare"><p className="c-dare-a">{l.dareA}</p><p className="c-dare-b">{l.dareB}</p><p className="c-dare-b">{l.dareC}</p><Go where="dare" /></section>
    {!home && !restored && <section className="c-quiz"><Quiz3 quals={quiz} ofLabel={l.question} kicker={l.askKicker} onDone={complete} /></section>}
      ...
      {proof && <VideoSpot cards={getVideos(locale)} locale={locale} heading={l.videoHead} playLabel={l.playLabel} planLabels={{ "10": l.plan10, "30": l.plan30 }} />}
    <div ref={reveal} className={passed ? "c-reveal" : "hidden"} aria-hidden={!passed}>
      ...
      {proof && <Rail slot="journey" head={l.railJourney} />}
      ...
      {proof && <Rail slot="progression" head={l.railProgression} />}
      <section className="c-section c-next">
        ...
        {home ? <p className="c-lede">{l.homeNext}</p> : <>
      ...
      {proof && <MoreTestimonials items={getTestimonials(locale, "more")} label={l.moreLabel} planLabels={{ "10": l.plan10, "30": l.plan30 }} />}
      <section className="c-close"><div><Heading a={l.closeA} b={l.closeB} /><p className="c-lede">{l.closeSubFlat.replace("{price}", price)}</p><p className="c-close-note">{l.closeNote}</p></div><Go where="close" className="c-full" /><Trust /></section>{home && <p className="c-partner-note">{l.partnerNote}</p>}<footer className="c-footer">{marketing.disclaimer}</footer>
    </div></main>{passed && <div className="c-mobile-buy"><Go where="mobile" compact /></div>}</div></>;
}
